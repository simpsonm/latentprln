...
## labels and outputs
#SBATCH -A stsn
#SBATCH -J metro_fit_2018_black_2
#SBATCH -o metro_fit_2018_black_2-%j.out
#SBATCH -e metro_fit_2018_black_2.e
#
## notifications
...
# start R
R --no-restore --no-save CMD BATCH metro_fit_2018_black_2.R
